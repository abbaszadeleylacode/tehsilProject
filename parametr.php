...
<!--                       <ul class="sub">
      ...
      <br>
        <br>
           <div class="text-center"> <h1>telebe parametrler</h1></div>
      </section>
      ...
      <br>
        <br>
           <div class="text-center"> <h1>muellim parametrler</h1></div>
      </section>
      <?php }else{ ?>
      <section id="main-content">
      <br>
      ...
      <br>
        <br>
           <div class="text-center"> <h1>Administrator parametrler</h1></div>
      </section>
